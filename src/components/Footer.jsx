const Footer = () => {
    return (
        <footer className="footer relative items-center p-4 border-t dark:border-base-100 bg-base-200 text-base-content w-full lg:px-10">
            <aside className="items-center grid-flow-col w-full mx-auto lg:w-auto lg:mx-0">
                ...
                <div className="w-full mx-auto text-center lg:w-auto lg:mx-0 lg:text-left">
